...
<body>
<c:url var="url" value="/client/san-pham"></c:url>
          ...
          <div class="card-body">
            <ul class="list-group list-group-flush">
              <li class="list-group-item">
                <a class="nav-link" href="${ url }/hien-thi">Tất cả</a>
              </li>
              <c:forEach items="${ listCategory }" var="i">
              <li class="list-group-item">
                <a class="nav-link" href="${ url }/category?id=${i.id}">${ i.tenLoai }</a>
              </li>
              </c:forEach>
            </ul>
          </div>
...
<a href="${ url }/detail?idDetail=${i.id}" class="nav-link link-dark">
  <img src="/Assignment/image/${ i.hinhAnh }" class="card-img-top" alt="..."></a>
  ...
  <a href="${ url }/detail?idDetail=${i.id}" class="nav-link link-dark">
    ...
    <a href="#" class="btn btn-outline-danger rounded-circle" ><i class="fa-solid fa-heart"></i></a>
    <a href="#" class="btn btn-outline-warning rounded-circle" ><i class="fa-solid fa-cart-shopping"></i></a>
  </div>
</div>
</div>
</c:forEach>
